...
install_V2bX() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget --no-check-certificate -N --progress=bar -O /usr/local/V2bX/V2bX-linux.zip https://github.com/ouyangmland/V2bX-singbox/releases/download/${last_version}/V2bX-linux-amd${arch}.zip
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://github.com/ouyangmland/V2bX-singbox/releases/download/${last_version}/V2bX-linux-amd${arch}.zip"
        echo -e "开始安装 V2bX $1"
